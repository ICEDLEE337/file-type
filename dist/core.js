...
export function fileTypeFromStream(stream) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            return yield fileTypeFromTokenizer(tokenizer);
        }
        finally {
...
class FileTypeParser {
    ...
    parse(tokenizer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.checkString('ID3')) {
                yield tokenizer.ignore(6); // Skip ID3 header until the header size
            ...
            if (this.check([0x50, 0x4B, 0x3, 0x4])) { // Local file header signature
                try {
                    while (tokenizer.position + 30 < tokenizer.fileInfo.size) {
                        ...
                        zipHeader.filename = yield tokenizer.readToken(new Token.StringType(zipHeader.filenameLength, 'utf-8'));
                        ...
                        if (zipHeader.filename === 'mimetype' && zipHeader.compressedSize === zipHeader.uncompressedSize) {
                            let mimeType = yield tokenizer.readToken(new Token.StringType(zipHeader.compressedSize, 'utf-8'));
            ...
            if (this.check([0x1A, 0x45, 0xDF, 0xA3])) { // Root element: EBML
                function readField() {
                    return __awaiter(this, void 0, void 0, function* () {
                        const msb = yield tokenizer.peekNumber(Token.UINT8);
                        let mask = 0x80;
                ...
                function readChildren(children) {
                    return __awaiter(this, void 0, void 0, function* () {
                        while (children > 0) {
                            ...
                            if (element.id === 17026) {
                                const rawValue = yield tokenizer.readToken(new Token.StringType(element.len, 'utf-8'));
                                return rawValue.replace(/\00.*$/g, ''); // Return DocType
                            }
                            yield tokenizer.ignore(element.len); // ignore payload
                            --children;
                        }
                    });
                }
            ...
            if (this.checkString('!<arch>')) {
                ...
                const string = yield tokenizer.readToken(new Token.StringType(13, 'ascii'));
            ...
            if (this.check([0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A])) {
                ...
                yield tokenizer.ignore(8); // ignore PNG signature
                function readChunkHeader() {
                    return __awaiter(this, void 0, void 0, function* () {
                        return {
                            length: yield tokenizer.readToken(Token.INT32_BE),
                            type: yield tokenizer.readToken(new Token.StringType(4, 'binary')),
                        };
                    });
                }
                do {
                    ...
                    switch (chunk.type) {
                        ...
                        default:
                            yield tokenizer.ignore(chunk.length + 4); // Ignore chunk-data + CRC
                    }
            ...
            if (this.check([0x30, 0x26, 0xB2, 0x75, 0x8E, 0x66, 0xCF, 0x11, 0xA6, 0xD9])) {
                function readHeader() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        return {
                            id: guid,
                            size: Number(yield tokenizer.readToken(Token.UINT64_LE)),
                        };
                    });
                }
            ...
            if (this.check([0x00, 0x00, 0x00, 0x0C, 0x6A, 0x50, 0x20, 0x20, 0x0D, 0x0A, 0x87, 0x0A])) {
                ...
                const type = yield tokenizer.readToken(new Token.StringType(4, 'ascii'));
                switch (type) {
                    case 'jp2 ':
                        return {
                            ext: 'jp2',
    ...
    readTiffTag(bigEndian) {
        return __awaiter(this, void 0, void 0, function* () {
            const tagId = yield this.tokenizer.readToken(bigEndian ? Token.UINT16_BE : Token.UINT16_LE);
    ...
    readTiffIFD(bigEndian) {
        return __awaiter(this, void 0, void 0, function* () {
            const numberOfTags = yield this.tokenizer.readToken(bigEndian ? Token.UINT16_BE : Token.UINT16_LE);
    ...
    readTiffHeader(bigEndian) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (version === 42) {
                ...
                return fileType !== null && fileType !== void 0 ? fileType : {
                    ext: 'tif',
                    mime: 'image/tiff',
                };
            }
...
export function fileTypeStream(readableStream, { sampleSize = minimumBytes } = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        const { default: stream } = yield import('node:stream');
            ...
            readableStream.once('readable', () => {
                (() => __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        const chunk = (_b = (_a = readableStream.read(sampleSize)) !== null && _a !== void 0 ? _a : readableStream.read()) !== null && _b !== void 0 ? _b : Buffer.alloc(0);
                        try {
                            const fileType = yield fileTypeFromBuffer(chunk);
